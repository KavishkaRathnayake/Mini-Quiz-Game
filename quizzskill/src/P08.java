...
int quizanswered = 0;
    ...
    /**
     * Creates new form P08
     */
    public P08(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("How do you comment a single-line in C?");
        ...
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 260, 210, -1));
        ...
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("-- ...");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("' ... ' ");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 350, -1, -1));
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is // ... ");
    ...
    private void G8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G8ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new P09(quizanswered , marks).setVisible(true);
        this.dispose();     
