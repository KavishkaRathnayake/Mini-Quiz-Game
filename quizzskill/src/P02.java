...
int quizanswered = 0;
     ...
     * Creates new form q4
     */
    public P02(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ORACLE is a ............. ?");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 940, 50));

        buttonGroup1.add(s1);
        s1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s1.setForeground(new java.awt.Color(255, 255, 255));
        s1.setText("Operating System");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 270, 270, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("RDBMS  ");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Interpreter");
        s3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s3ActionPerformed(evt);
            }
        });
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 330, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Compiler");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 360, -1, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Kavishka\\Downloads\\Yellow Black Minimalist Fun Quiz Session Facebook Post (4).png")); // NOI18N
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is RDBMS");
    ...
    private void G2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G2ActionPerformed
        ...
        new P03(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P02.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
