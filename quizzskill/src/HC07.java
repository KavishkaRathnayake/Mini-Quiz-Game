 ...
 * @author Kavishka
 */
public class HC07 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC07
     */
    public HC07(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which was the first commercial computer?  ");
        ...
        s1.setText("Ferranti Mark 1   ");
        s1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s1ActionPerformed(evt);
            }
        });
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 230, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Analytical Engine");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Difference Engine");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Colossus");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 350, -1, -1));

        G7.setBackground(new java.awt.Color(0, 153, 255));
        G7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        getContentPane().add(G7, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 500, 90, 30));
        ...
        AnswerStatus.setForeground(javax.swing.UIManager.getDefaults().getColor("CheckBox.icon.disabledCheckmarkColor"));
    ...
    private void G7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G7ActionPerformed
      //prevent go to next question without selecting an answer
        ...
        new HC08(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
      ...
      // check the user selected option, otherwise show an error message.
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s1.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Ferranti Mark 1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC07.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
