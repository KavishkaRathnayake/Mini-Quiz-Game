 ...
 * @author Kavishka
 */
public class HC06 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC06
     */
    public HC06(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("What's the name of the inventor of the Analytical Machine?");
        ...
        s1.setText(" Albert Einstein");
        s1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s1ActionPerformed(evt);
            }
        });
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 260, 240, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Stephen Hawking");
        ...
        s4.setText("Konrad Zuse");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 350, -1, -1));

        G6.setBackground(new java.awt.Color(0, 153, 255));
        G6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        getContentPane().add(G6, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 500, 90, 30));
    ...
    private void G6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G6ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new HC07(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s3.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Charles Babbage");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC06.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
