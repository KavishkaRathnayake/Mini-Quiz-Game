 ...
 * @author Kavishka
 */
public class GK08 extends javax.swing.JFrame {
    int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form GK08
     */
    public GK08(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A computer use which type of number system to calculate and to store data ?");
        ...
        s1.setText("Decimal");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 200, -1));
    ...
    private void G8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G8ActionPerformed
        ...
        new GK09(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s3.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Binary ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GK08.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
