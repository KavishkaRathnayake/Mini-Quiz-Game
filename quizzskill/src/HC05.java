 ...
 * @author Kavishka
 */
public class HC05 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC05
     */
    public HC05(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("The First Generation of Computers used what?");
        ...
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 260, 210, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText(" Vacuum Tubes ");
        ...
        s3.setText("Integrated Circuits");
    ...
    private void G5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G5ActionPerformed
        ...
        new HC06(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Vacuum Tubes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC05.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
