 ...
 * @author Kavishka
 */
public class GK06 extends javax.swing.JFrame {
    int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form GK06
     */
    public GK06(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Linus Torvalds develop which operating System?");
        ...
        s1.setText("Windows");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 140, -1));
    ...
    private void G6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G6ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new GK07(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s4.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Linux");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GK06.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
