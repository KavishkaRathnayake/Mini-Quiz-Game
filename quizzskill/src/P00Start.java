 ...
 * @author Kavishka
 */
public class P00Start extends javax.swing.JFrame {

    /**
     * Creates new form P00Start
     */
    public P00Start() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Computer Programming - Start");
        setResizable(false);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setFont(new java.awt.Font("Stencil Std", 0, 60)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Computer programming");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P00Start.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
