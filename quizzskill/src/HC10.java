 ...
 * @author Kavishka
 */
public class HC10 extends javax.swing.JFrame {
 int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC10
     */
    public HC10(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" ____ is used as a programming language in first generation computers?");
        ...
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 260, 310, -1));
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s4.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Machine Language");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
