 ...
 * @author Kavishka
 */
public class GK07 extends javax.swing.JFrame {
    int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form GK07
     */
    public GK07(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("In computer world, Trojan refer to ?");
        ...
        s1.setText("Virus");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 260, 80, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Malware");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Worm");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Spyware");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 350, -1, -1));
    ...
    private void G7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G7ActionPerformed
      //prevent go to next question without selecting an answer
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new GK08(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    private void btnCheckanswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckanswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Malware");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GK07.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
