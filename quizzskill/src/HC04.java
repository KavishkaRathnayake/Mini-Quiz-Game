 ...
 * @author Kavishka
 */
public class HC04 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC04
     */
    public HC04(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Who developed the first program?");
        ...
        s1.setText("Alan Turing");
        s1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s1ActionPerformed(evt);
            }
        });
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 260, 200, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Charles Babbage");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Ada Lovelace");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Tim Berners Lee");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 350, -1, -1));
    ...
    private void G4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G4ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new HC05(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s3.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Ada Lovelace");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC04.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
