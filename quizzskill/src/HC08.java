 ...
 * @author Kavishka
 */
public class HC08 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form HC088
     */
    public HC08(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Who invented the punch card?");
        ...
        s1.setText("Charles Babbage");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 320, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Semen Korsakov");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Herman Hollerith  ");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Joseph Marie Jacquard");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 350, -1, -1));

        G8.setBackground(new java.awt.Color(0, 153, 255));
        G8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        getContentPane().add(G8, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 500, 90, 30));
        ...
        AnswerStatus.setForeground(javax.swing.UIManager.getDefaults().getColor("CheckBox.icon.disabledBorderColor"));
    ...
    private void G8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G8ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new HC09(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s3.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Herman Hollerith");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC08.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
