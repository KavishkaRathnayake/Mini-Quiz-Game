 ...
 * @author Kavishka
 */
public class P06 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form P06
     */
    public P06(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which of the following languages is usually implemented with an interpreter ? ");
        ...
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 200, -1));
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Assembly");
    ...
    private void G6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G6ActionPerformed
        ...
        new P07(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P06.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
