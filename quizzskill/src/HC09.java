 ...
 * @author Kavishka
 */
public class HC09 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form Hc09
     */
    public HC09(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which electronic components are used in Fifth Generation Computers?");
        ...
        s1.setText("Transistors");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 300, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Integrated Circuits");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 290, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("VLSI Microprocessor");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("ULSI Microprocessor");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 350, -1, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Kavishka\\Downloads\\Yellow Black Minimalist Fun Quiz Session Facebook Post (3).png")); // NOI18N
    ...
    private void G9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G9ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new HC10(quizanswered , marks).setVisible(true);
        this.dispose();     
        }
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
     ...
     if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s4.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is ULSI Microprocessor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HC09.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
