 ...
 * @author Kavishka
 */
public class P09 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form P09
     */
    public P09(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("What does \"printf\" do in C programming?");
        ...
        s1.setText("Scans input from the user");
        ...
        s2.setText("Prints output to the console ");
        s2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s2ActionPerformed(evt);
            }
        });
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 300, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Performs arithmetic operations");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 330, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Declares variables");
        s4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s4ActionPerformed(evt);
            }
        });
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, -1, -1));
        ...
        G9.setBackground(new java.awt.Color(0, 153, 255));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Kavishka\\Downloads\\Yellow Black Minimalist Fun Quiz Session Facebook Post (4).png")); // NOI18N
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Prints output to the console");
    ...
    private void G9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G9ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new P10(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P09.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
