 ...
 * @author Kavishka
 */
public class GK05 extends javax.swing.JFrame {
    int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form GK05
     */
    public GK05(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which storage technology is non-volatile used in USB drives and memory cards?");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 180, 940, -1));
        ...
        s1.setText("HDD (Hard Disk Drive)");
        s1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                s1ActionPerformed(evt);
            }
        });
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, -1, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("SSD (Solid State Drive) ");
    ...
    private void G5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G5ActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
        ...
        new GK06(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
        ...
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s2.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is SSD (Solid State Drive)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GK05.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
