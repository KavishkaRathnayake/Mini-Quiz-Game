...
int quizanswered = 0;
     ...
     */
    public P10(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("What is finding and fixing errors in programs?");
        ...
        s1.setText("Debugging ");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 270, 220, -1));

        buttonGroup1.add(s2);
        s2.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s2.setForeground(new java.awt.Color(255, 255, 255));
        s2.setText("Program");
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 300, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("Bug");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 330, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("Code ");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 360, -1, -1));
       ...
       // check the user selected option, otherwise show an error message.
        if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s1.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is Debugging");
