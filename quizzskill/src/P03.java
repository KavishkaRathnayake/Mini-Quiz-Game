 ...
 * @author Kavishka
 */
public class P03 extends javax.swing.JFrame {
int quizanswered = 0;
    int marks = 0;
    /**
     * Creates new form P05
     */
    public P03(int questionAnswered , int marks) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Which programming language is often referred to as \"mother of all languages\" ?");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 940, -1));

        buttonGroup1.add(s1);
        s1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s1.setForeground(new java.awt.Color(255, 255, 255));
        s1.setText("Python");
        getContentPane().add(s1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 270, 230, -1));
        ...
        getContentPane().add(s2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 300, -1, -1));

        buttonGroup1.add(s3);
        s3.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s3.setForeground(new java.awt.Color(255, 255, 255));
        s3.setText("C  ");
        getContentPane().add(s3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 330, -1, -1));

        buttonGroup1.add(s4);
        s4.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        s4.setForeground(new java.awt.Color(255, 255, 255));
        s4.setText("SQL");
        getContentPane().add(s4, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 360, -1, -1));

        G3.setBackground(new java.awt.Color(0, 153, 255));
    ...
    private void btnCheckAnswerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckAnswerActionPerformed
       ...
       if(!s1.isSelected()&& !s2.isSelected() && !s3.isSelected() && !s4.isSelected()) {
            ...
            if (s3.isSelected()){
                ...
                AnswerStatus.setText("Incorrect, Answer is C");
    ...
    private void G3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_G3ActionPerformed
      //prevent go to next question without selecting an answer
        ...
        new P04(quizanswered , marks).setVisible(true);
        this.dispose();     
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
